...
const Signup = (props) => {
  ...
  const handleSignup = async (e) => {
    ...
    if (loginResponse.success) {
      ...
      navigate("/");
      props.showAlert("You Are SuccessFully Signed Up", "success");
    }
    else{
      props.showAlert("Invalid Credentials or Email Already Exists With Another User!", "danger");
    }
  };
  return (
      ...
      >
        ...
        {formTouch && (
          <div id="emailHelp" className="form-text">
            {credentials.mpassword === "" ? (
              <p></p>
            ) : credentials.cpassword === credentials.mpassword ? (
            ...
            {credentials.name === "" ? (
              <p className="text-danger lh-1">&#10006;Name Can't Be Blank!!</p>
            ) : (
              <p></p>
            )}
            {credentials.mpassword === "" ? (
            ...
            {!(credentials.mpassword.length >= 6) ? (
              <p className="text-danger lh-1">
